...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func logUserOut() {
        ...
        UserDefaults.standard.setValue(nil, forKey: "gender")
        UserDefaults.standard.setValue(nil, forKey: "showGender")
    ...
    func showLoginAsRootVC() {
        let storyboard = UIStoryboard(name: "OnBoardScreens", bundle: nil)
        let loginFormVC = storyboard.instantiateViewController(identifier: "LoginFormVC") as! LoginFormVC
        
        self.window?.rootViewController = loginFormVC
        self.window?.makeKeyAndVisible()
    }
    
    func setHomeAsRootVC() {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let homeTab = storyboard.instantiateViewController(identifier: "HomeTab") as! HomeTab
